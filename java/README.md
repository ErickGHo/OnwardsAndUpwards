...
This was an interesting take on the definition of a coin mixer. I've used mixers in the past, and generally, the input to output in my experience with mixers were 1:1, and the house contained multiple addresses to send from instead.
